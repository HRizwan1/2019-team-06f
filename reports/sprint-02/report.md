...
### Project Accomplishments: Goals Accomplished (11/13)
  ...
  * Successfully build web server
  * Successfully build database server
...
1. Language and Framework of Choice:
  ...
  * HTML is used to structure the wewbpages
  * CSS is used to style our web-pages 
  * Javascript / jQuery is used for the photo slideshow on the gallery page
  * PHP is used for generating login and register process
  * Vagrant and Packer is used for building the web server and database server
  * Apache web server hosts HTML, PHP, Javascript, and CSS
  * Redis is used for storing a portion of the database entries and allow for faster searching and reads from the webserver
...
5. Use of Master & Slave Replication:
  * 2 Database Servers running MySQL - 1 server will serve as a master server to write and 1 server will be a slave that is to read.
